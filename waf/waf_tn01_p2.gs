...
'set y 1 73'
*'set t 229 492'
'define uclm = ave(uwnd.1,time=apr1988,time=apr2014,1yr)'
'define vclm = ave(vwnd.2,time=apr1988,time=apr2014,1yr)'
'define zclm = ave(hgt.3, time=apr1988,time=apr2014,1yr)'
...
'printim EEU_WAF_hf_P2.png white'
*'disable print'
;
